...
const server = http.createServer((request, response) => {
    ...
    */
    ...
    /*
        routeObject -> Propriedades da posicao do array do arquivo de rotas.
        Verificando se a rota existe, de acordo com o valor que esta sendo passsado juntamente
        com o seu metodo de execucao.
    */
    ...
    if(route) {
        ...
        /* includes -> Verificando se algum destes metodos encontra-se na request passada. */
        if(['POST', 'PUT', 'PATCH'].includes(request.method)) {
            bodyParser(request, () => route.handler(request, response))
        } else {
            route.handler(request, response) /* Executa a funcao direto caso nao seja um dos metodos acima.*/
        } 
